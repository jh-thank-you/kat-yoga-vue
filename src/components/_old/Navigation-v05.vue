...
<template>
  <div
    ...
    :class="{
      ...
      // 'homepage-mobile-nav': mobileHomeNav,
      'mobile-nav-open': mobileNav,
      // 'move-nav-back-up': !isPageOpen,
    }"
  >
    <header :class="{ 'scrolled-nav': scrollPosition }">
      <nav>
        ...
        <transition-group name="mobile-nav" mode="out-in">
          ...
          >
            <!-- <keep-alive v-bind:max="4"> -->
            <transition name="mobile-nav" mode="out-in">
              <!-- <div v-show="!mobile" key="mobileNavFalse01" class="navigation"> -->
        ...
        <!-- <div
          ...
          v-show="!mobile || mobileHomeNav"
          class="navigation-wrapper"
          :class="{
            'page-is-open': $route.name !== '/',
            'homepage-mobile-nav': mobileHomeNav,
            // 'page-is-open': mobileHomeNav,
          }"
        > -->
        ...
        <transition name="mobile-nav" mode="out-in">
          ...
          >
            <div key="02" class="navigation">
              <!-- <div v-show="mobile" key="02" class="navigation"> -->
              <div
